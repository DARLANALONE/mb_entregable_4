...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset("imagenes/logo.png") }}">
    <title>Medical Bases - sistema de informacion dental</title>
    <link rel="stylesheet" type="text/css" href={{ asset("css/bootstrap.min.css") }}>
    <link rel="stylesheet" type="text/css" href={{ asset("css/font-awesome.min.css") }}>
    <link rel="stylesheet" type="text/css" href={{ asset("css/select2.min.csss") }}>
    ...
    <div class="header">
        <div class="header-left">
            <a href="index-2.html" class="logo">
                <img src="{{ asset('imagenes/nuevo isologo primera forma.png') }}" width="35" height="35" alt=""> <span>MEDICAL BASES</span>           </a>
        </div>
        ...
        <ul class="nav user-menu float-right">
            <li class="nav-item dropdown d-none d-sm-block">
                ...
                <div class="dropdown-menu notifications">
                    ...
                    <div class="topnav-dropdown-footer">
                        <a href="activities.html">Notificaciones</a>
                    </div>
                </div>
            </li>
            <li class="nav-item dropdown d-none d-sm-block">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-square" src="{{ asset('img/user.jpg') }}" width="24" alt="foto_admin">
							<span class="status online"></span></span>
                    <span>Doctor Administrador</span>
                </a>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="active">
                        <a href="../../../doctor.blade.php"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                    </li>
                    <li>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="{{ url('add-doctor') }}" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Nuevo Doctor</a>
                </div>
            </div>
