...
{{--                    -------ubicacion de la parte superior derecha del dashboard, donde aparece el administrador con sus funciones--}}
        ...
        <div class="dropdown mobile-user-menu float-right">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="edit-profile.html">Edit Profile</a>
                <a class="dropdown-item" href="settings.html">Settings</a>
                <a class="dropdown-item" href="http://127.0.0.1:8000/login">salir1</a>
            </div>
        </div>
    </div>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ url('index') }}"><i class="fa fa-user-md"></i> <span>Doctores</span></a>
                    </li>
                    <li>
                        <a href="{{ url('pacientes') }}"><i clas="fa fa-wheelchair"></i> <span>Patients</span></a>
                    </li>
                    <li>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="card member-panel">
                        ...
                        <div class="card-footer text-center bg-white">
                            <a href="../../../doctor.blade.php" class="text-muted">View all Doctors</a>
                        </div>
                    </div>
                </div>
            </div>
